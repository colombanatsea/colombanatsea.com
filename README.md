...
└── src/                          # (à venir) Code source du site
```

## Prototypes

Chaque prototype est un fichier HTML autonome (self-contained). Ouvrir directement dans un navigateur.

| Proto | Tech | Description |
|-------|------|-------------|
...
|-----|---------|-------------|
| **Technologique** | `#2a55b3` | Digitalisation, IA, data maritime |
| **Environnementale** | `#00bf63` | Limites planétaires, décarbonation, EMR |
| **Socioculturelle** | `#b32a55` | Culture maritime, formation, plaidoyer |
