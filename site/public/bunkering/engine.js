...
(function (root) {
  ...
  // ---------------------------------------------------------------- parametres
  const CATALOG = [
    ["density_15c","Density @ 15°C","kg/m3","numeric","common",["density","density @ 15c","density@15c","density at 15c","density 15c","density @15c"]],
    ["viscosity_40c","Viscosity @ 40°C","cSt","numeric","distillate",["k viscosity at 40c","viscosity at 40c","viscosity 40c","viscosity (40c)","kinematic viscosity at 40c","viscosity@40c"]],
    ["viscosity_50c","Viscosity @ 50°C","cSt","numeric","residual",["viscosity at 50c","viscosity 50c","viscosity @50c","kinematic viscosity at 50c","viscosity@50c"]],
    ["viscosity_100c","Viscosity @ 100°C","cSt","calculated","residual",["viscosity at 100c","viscosity 100c"]],
    ["flash_point","Flash point","degC","numeric","common",["flash","flash pt","flashpoint","flash point pmcc"]],
    ["pour_point","Pour point","degC","numeric","common",["pour pt","pourpoint"]],
    ["cloud_point","Cloud point","degC","numeric","distillate",["cloud pt"]],
    ["cfpp","CFPP","degC","numeric","distillate",["cold filter plugging point"]],
    ["micro_carbon_residue","Micro carbon residue","%m/m","numeric","common",["mcr","mcr 10%","micro carbon residue (10%)","micro carbon residue","carbon residue micro method","ccr","conradson carbon","micro carbon residue 10%","mcr10%"]],
    ["ash","Ash","%m/m","numeric","common",["ash content","ash content at 550c","ash content at 775c"]],
    ["water","Water","%v/v","numeric","common",["water content","water content by ke","moisture"]],
    ["sulphur","Sulphur","%m/m","numeric","common",["sulfur","sulphur content","sulfur content","sulphur (s)"]],
    ["total_sediment","Total sediment","%m/m","numeric","residual",["total sediment potential","total sediment aged","tsp","tsa","total sediment accelerated","total sediment acc","sediment"]],
    ...
    ["silicon","Silicon","mg/kg","numeric","metal",["si"]],
    ["aluminium_silicon","Aluminium + Silicon (catfines)","mg/kg","numeric","residual",["al+si","al + si","aluminium + silicon","aluminum + silicon","al+si (catfines)","aluminium+silicon","catfines","al/si"]],
    ["iron","Iron","mg/kg","numeric","metal",["fe"]],
    ["nickel","Nickel","mg/kg","numeric","metal",["ni"]],
    ["calcium","Calcium","mg/kg","numeric","metal",["ca"]],
    ["zinc","Zinc","mg/kg","numeric","metal",["zn"]],
    ["phosphorus","Phosphorus","mg/kg","numeric","metal",["phosphorous","p"]],
    ["potassium","Potassium","mg/kg","numeric","metal",["k"]],
    ["magnesium","Magnesium","mg/kg","numeric","metal",["mg"]],
    ["lead","Lead","mg/kg","numeric","metal",["pb"]],
    ["ccai","CCAI","-","calculated","residual",["ccai (ignition quality)","calculated carbon aromaticity index"]],
    ["cetane_index","Cetane index","-","numeric","distillate",["calculated cetane index","cci"]],
    ["acid_number","Acid number","mg KOH/g","numeric","common",["tan","total acid number","strong acid number","san"]],
    ["net_specific_energy","Net specific energy","MJ/kg","calculated","common",["nse","net calorific value","ncv"]],
    ["gross_specific_energy","Gross specific energy","MJ/kg","calculated","common",["gse","gross calorific value","gcv"]],
    ["api_gravity","API gravity","-","calculated","common",["api"]],
    ["fame","FAME","%v/v","numeric","common",["fame content","biofuel ratio","biofuel","biodiesel"]],
    ["appearance","Appearance","-","qualitative","common",["visual"]],
    ["colour","Colour","-","qualitative","common",["color"]],
