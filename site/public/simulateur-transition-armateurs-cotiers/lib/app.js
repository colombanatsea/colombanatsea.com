...
function computeAide(proj, surcout) {
  ...
  const aide = Math.min(surcout * taux / 100, 6000); // plafonné à 6M€
  return {
    taux,
    aide,
    regime,
...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onChange: v => uV("pQu", v),
    u: "%"
  }))), batt && /*#__PURE__*/React.createElement(Cd, {
    title: "\uD83D\uDCCA Pr\xE9-dimensionnement batteries (automatique)",
    accent: T
  }, /*#__PURE__*/React.createElement("div", {
    ...
    value: proj.dnsh?.[i]?.text || axis.template,
    onChange: e => upd(p => {
      const dnsh = [...(p.dnsh || [])];
      dnsh[i] = {
        ...dnsh[i],
    ...
    title: "Postes de d\xE9penses \xE9ligibles"
